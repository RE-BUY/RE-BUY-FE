        ...
        <Layout>
            <div className="flex flex-col h-full bg-white relative">
                ...
                <div className="absolute bottom-0 w-full p-5 bg-white border-t border-gray-100">
                    <button
                        className="w-full py-4 bg-main text-white text-lg font-bold rounded-xl shadow-lg hover:bg-[#3d5a44] transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex justify-center items-center"
